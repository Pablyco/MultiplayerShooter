...
void UMultiplayerSessionsSubsystem::CreateSession(int32 NumPublicConnections, FString MatchType)
{
	...
	//Store the delegate handle in FDelegateHandle so we can later remove it from the delegate list
...
void UMultiplayerSessionsSubsystem::FindSession(int32 MaxSeachResults)
{
	if (!SessionInterface.IsValid()){return;}
